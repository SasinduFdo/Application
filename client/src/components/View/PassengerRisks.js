    ...
    <>
      ...
      >
        ...
        >
          <thead>
            <tr>
              <th style={{ width: "15%", height: 5 }}>Fore Name</th>
              <th style={{ width: "15%", height: 5 }}>Family Name</th>
              <th style={{ width: "10%", height: 3 }}>Gender</th>
              <th style={{ width: "15%", height: 5 }}>Passport Number</th>
              <th style={{ width: "10%", height: 3 }}>Flight Number</th>
              <th style={{ width: "10%", height: 3 }}>Seat Number</th>
              <th style={{ width: "10%", height: 3 }}>Passenger's Country</th>        
          ...
          <tbody>
            {riskData.map((risk) => (
              <tr>
                ...
                >
                  {risk.riskModelRiskData.riskDataForename}
                </td>
                <td
                  style={{
                    width: "15%",
                ...
                >
                  {risk.riskModelRiskData.riskDataFamilyName}
                </td>
                <td
                  style={{
                    width: "10%",
                ...
                >
                  {risk.riskModelRiskData.riskDataGender}
                </td>
                <td
                  style={{
                    width: "15%",
                ...
                >
                  {risk.riskModelRiskData.riskDataPassportNumber}
                </td>
                <td
                  style={{
                    width: "10%",
